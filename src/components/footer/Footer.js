  ...
  render () {
    return (
      <footer className='bloc_page'>
        <div className='com'>
          <img src='https://pngimage.net/wp-content/uploads/2018/06/logo-cocktail-png-6.png' alt='logo' title='logo' />
          <h3>GuestBook</h3>
        ...
        <div className='contact'>
          ...
          <img src='https://miro.medium.com/max/621/1*XyvBPSfQebxwD652YQOtqw.png' alt='Nos réseaux sociaux' title='Nos réseaux sociaux' />
        </div>
